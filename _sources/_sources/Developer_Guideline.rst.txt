...
---------------------------------
1. Fork the LITESOPH/litesoph-pipeline repo into your github account.

2. ‘git clone’ this newly forked repo into your local machine.

.. Warning::
   Don’t directly clone from LITESOPH/litesoph-pipeline.
...
.. image:: ./Image/LITESOPH_Architecture.png
   :width: 800
   :alt: LITESOPH_home

Workflow of LITESOPH:
#######################
The overall workflow of LITESOPH is as the following:
...
Modules of LITESOPH: 
-----------------------
The modules of LITESOPH for the LITESOPH-Developer is as the following.
